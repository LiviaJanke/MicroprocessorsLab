...
ADC_Init:	; set all the right tristates - only needs to be done once
	bsf	TRISF, READX, A
...
ADC_Setup_X:	; set the ADC to measure voltage from RF5 = ReadX
...
ADC_Setup_Y:	; set the ADC to measure voltage from RF2 = ReadY
